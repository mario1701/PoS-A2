...
#@ error = job$(jobid).err
#@ notification=always
#@ notify_user=yunqing.dong@tum.de
#@ queue
. /etc/profile
...
mpiexec -n 1 ./gccg bin tjunc.bin tjunc_bin_1
mv summary.out summary_tjunc_bin_1
mpiexec -n 1 ./gccg bin tjunc.bin tjunc_bin_2
mv summary.out summary_tjunc_bin_2
mpiexec -n 1 ./gccg bin tjunc.bin tjunc_bin_3

...
int write_result(char *infilename, char *outfilename, int nintci, int nintcf,
        double *var, int iter, double ratio, long long *counters, float rtime, float ptime, float mflops, long long flpops, long long *countersm)
{
    ...
    fprintf(fp, "     ============\n\n");  
    fprintf(fp, "     Mflops(from hign level functions) is: %f \n\n",mflops);          
    fprintf(fp, "     ============\n\n");
    /*fprintf(fp, "     Floating point operations; optimized to count scaled single precision vector operations: %lld.\n\n", countersm[0]);      
    fprintf(fp, "     ============\n\n");*/
    fprintf(fp, "     Floating point operations; optimized to count scaled double precision vector operations: %lld.\n\n", countersm[0]);   
    fprintf(fp, "     ============\n\n");
    fprintf(fp, "     Flops: %le \n\n", (double)((countersm[0])/ptime));   
    fprintf(fp, "     ============\n\n");
